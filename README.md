...
這版修正兩份指令的工具適用範圍與執行邊界。對話型工具版本在純對話任務中不會因本機工具或沙盒規則而加重；代理式工具版本的範圍對齊 OpenAI Codex、Claude Code、Antigravity CLI、Cursor。
...
| 版本 | 日期 | 主要變更 |
|---|---|---|
| [v0.7.2](docs/releases/v0.7.2.md) | 2026-07-06 | 修正沙盒與本機工具分流；列明 01 給 ChatGPT／Claude／Cowork，02 給 OpenAI Codex／Claude Code／Antigravity CLI／Cursor。 |
